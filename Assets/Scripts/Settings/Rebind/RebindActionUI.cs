...
public class RebindActionUI : MonoBehaviour
    ...
    private void Save()
    {
        InputAction actualAction = null;
        foreach (var map in ControlsManager.instance.controls.asset.actionMaps)
        {
    ...
    private bool CheckDuplicateBinding(InputBinding bindingToCheckAgainst)
    {
        ...
        foreach (var actionMap in ControlsManager.instance.controls.asset.actionMaps)
        {
